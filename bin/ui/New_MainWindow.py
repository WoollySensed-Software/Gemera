...
from PySide6.QtGui import QCursor, QFont, QDoubleValidator
...
class MainWindowUI(QWidget):
    ...
    def setup_ui(self):
        ...
        self.top_bar_spacer = QSpacerItem(50, 30, QSizePolicy.Expanding, 
                                          QSizePolicy.Minimum)
        ...
        self.btn_tb_full_screen.clicked.connect(self._resizeWindow)
        ...
        self.top_bar_hlayout.addItem(self.top_bar_spacer)
        ...
        self.widget_modes_frame.setMinimumSize(QSize(350, 250))
        ...
        self.modes_vlayout.setSpacing(0)
        self.modes_vlayout.addStretch(1)
        ...
        self.widget_input_data_frame.setMinimumSize(QSize(350, 250))
        ...
        self.hlayout_id_1 = QHBoxLayout()
        self.hlayout_id_1.setContentsMargins(0, 0, 0, 0)
        self.hlayout_id_1.setSpacing(0)
        self.hlayout_id_1.addWidget(self.lbl_input_data_1)
        self.hlayout_id_1.addWidget(self.ted_input_data_1)
        ...
        self.hlayout_id_2 = QHBoxLayout()
        self.hlayout_id_2.setContentsMargins(0, 0, 0, 0)
        self.hlayout_id_2.setSpacing(0)
        self.hlayout_id_2.addWidget(self.lbl_input_data_2)
        self.hlayout_id_2.addWidget(self.ted_input_data_2)
        ...
        self.hlayout_id_3 = QHBoxLayout()
        self.hlayout_id_3.setContentsMargins(0, 0, 0, 0)
        self.hlayout_id_3.setSpacing(0)
        self.hlayout_id_3.addWidget(self.lbl_input_data_3)
        self.hlayout_id_3.addWidget(self.ted_input_data_3)
        ...
        self.hlayout_id_4 = QHBoxLayout()
        self.hlayout_id_4.setContentsMargins(0, 0, 0, 0)
        self.hlayout_id_4.setSpacing(0)
        self.hlayout_id_4.addWidget(self.lbl_input_data_4)
        self.hlayout_id_4.addWidget(self.ted_input_data_4)
        ...
        self.input_data_vlayout.addStretch(1)

        self.input_data_vlayout.addWidget(self.lbl_input_data_title)
        self.input_data_vlayout.addLayout(self.hlayout_id_1)
        self.input_data_vlayout.addLayout(self.hlayout_id_2)
        self.input_data_vlayout.addLayout(self.hlayout_id_3)
        self.input_data_vlayout.addLayout(self.hlayout_id_4)

        # --- область кнопок управления ---
        self.widget_butttons_frame = QWidget()
        self.widget_butttons_frame.setMinimumSize(QSize(350, 100))
        ...
        self.widget_output_data_frame.setMinimumSize(QSize(350, 150))
        ...
        self.hlayout_od_1 = QHBoxLayout()
        self.hlayout_od_1.setContentsMargins(0, 0, 0, 0)
        self.hlayout_od_1.setSpacing(0)
        self.hlayout_od_1.addWidget(self.lbl_output_data_1)
        self.hlayout_od_1.addWidget(self.ted_output_data_1)
        ...
        self.hlayout_od_2 = QHBoxLayout()
        self.hlayout_od_2.setContentsMargins(0, 0, 0, 0)
        self.hlayout_od_2.setSpacing(0)
        self.hlayout_od_2.addWidget(self.lbl_output_data_2)
        self.hlayout_od_2.addWidget(self.ted_output_data_2)
        ...
        self.vlayout_od = QVBoxLayout()
        self.vlayout_od.setContentsMargins(0, 0, 0, 0)
        self.vlayout_od.setSpacing(0)
        self.vlayout_od.addLayout(self.hlayout_od_1)
        self.vlayout_od.addLayout(self.hlayout_od_2)

        self.hlayout_od_3 = QHBoxLayout()
        self.hlayout_od_3.setContentsMargins(0, 0, 0, 0)
        self.hlayout_od_3.setSpacing(0)
        self.hlayout_od_3.addLayout(self.vlayout_od)
        self.hlayout_od_3.addWidget(self.btn_reset_pressure)
        ...
        self.output_data_vlayout.addLayout(self.hlayout_od_3)
        
        self.central_glayout = QGridLayout(self.widget_central_area)
        self.central_glayout.setContentsMargins(0, 0, 0, 0)
        self.central_glayout.setSpacing(0)

        self.central_glayout.addWidget(self.widget_modes_frame, 0, 0)
        self.central_glayout.addWidget(self.widget_input_data_frame, 0, 1)
        self.central_glayout.addWidget(self.widget_butttons_frame, 1, 0)
        self.central_glayout.addWidget(self.widget_output_data_frame, 1, 1)
        # self.central_glayout.addWidget(self.widget_graph_frame, 0, 2)
        self.central_glayout.addWidget(self.graph_handler.view, 0, 2)
        """/CentralWidget"""
        ...
        self.bottom_bar_spacer = QSpacerItem(50, 30, QSizePolicy.Expanding, 
                                             QSizePolicy.Minimum)

        # --- кнопка открытия меню весов ---
        self.btn_open_weigher_menu = QPushButton()
        self.btn_open_weigher_menu.setFont(QFont('Sans Serif', 10))
        self.btn_open_weigher_menu.setText('МЕНЮ ВЕСОВ')
        self.btn_open_weigher_menu.setFixedSize(QSize(120, 20))
        ...
        self.bottom_bar_hlayout.addSpacerItem(self.bottom_bar_spacer)
        self.bottom_bar_hlayout.addWidget(self.btn_open_weigher_menu)
